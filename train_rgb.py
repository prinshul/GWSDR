...
flow_train_path = ["../crossval5_8/f_train"+str(i)+".p" for i in range(5)]
rgb_train_path = ["../crossval5_8/r_train"+str(i)+".p" for i in range(5)]
label_train_path = ["../crossval5_8/l_train"+str(i)+".p" for i in range(5)]
...
for i in range(2,5):
        ...
        rgb_model.fit_generator(generate_arrays_from_file(rgb_train_data, label_train_data), steps_per_epoch=steps, epochs=65)
...
#        flow_model.save("data/0_8/flow"+str(i)+".h5")
